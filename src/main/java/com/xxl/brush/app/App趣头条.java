...
public class App趣头条 {
     ...
     */
    public static void init(Robot robot, AndroidDriver driver){
        try{
            robot.delay(2000);
            WebElement wl11 = driver.findElementByAndroidUIAutomator("className(\"android.widget.TextView\").text(\"点击展开更多\")");
            wl11.click();
            robot.delay(2000);
        }catch (Exception e){}
