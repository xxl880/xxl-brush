...
public class App聚看点新闻 {
    private static Logger log = LoggerFactory.getLogger(App聚看点新闻.class);
    ...
    public static void handle(Robot robot,String robotCode){
        ...
        log.info("2.启动app");
        AdbTools.startup(robot, androidId, AppConstants.startup聚看点);
